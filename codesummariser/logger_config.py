...
def setup_logger(
    ...
    -------
        ...
        file_log_level: int
            Optional, The level of log to output to the file, any of the standard logging
            levels
        console_log_level: int
            Optional, The level of log to output to the console, any of the standard logging
            levels
        catch_errors: Bool
